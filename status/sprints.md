...
## Незапланированные задачи
  - Женя: Подготовить GaltProject UI для Демо показа
    - Автообновление информации(количество токенов, геохешей у пользователя или в упаковке/заявке, автообновление списков при изменении фильтрации), 2 часа.
    - Правка верстки и отображаемой информации для более представительного вида, 1 час.
    - Показ дополнительной информации для облегчения понимания пользователем, 1 час.
    - Дополнительная валидация и предупреждение пользователя о невозможности совершить действие, 2 часа.
  - Подготовка деплоя на продакшн:
    - Никита: Подготовка удаленной ноды для стабильной работы, тестирование работы, 4 часа
    - Женя: Подготовка конфигураций и деплоя контрактов и фронта для нескольких сетей(ganache, testnet56, local parity), тестирование работы связки контрактов и фронта, 4 часа
