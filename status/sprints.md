...
* Скопировать необходимую логику (initializer, application getter, application struct) и тесты с контракта PlotManager - 120мин
...
* Метод оплаты заявки пользователем
    ...
    * Рассчет комисси валидаторов - 240 мин
...
* Метод добавления валидатором новых геохешей в упаковку - 180 мин
    * Передача токена обратно заявителю

* Метод вывода валидаторами своих вознаграждений за заявку - 240 мин
* Метод вывода владельцем контракта вознаграждения - 120 мин
* Метод revertApplication - 180 мин
    * Автоматический перевод токена обратно заявителю - 180 мин
    * Полного отказа в заявке не предусмотрено
* Метод редактирования полей заявки заявителем (сразу всех) - 120 мин
* Возврат заявки заявителем - 150мн
