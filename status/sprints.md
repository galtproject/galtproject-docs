...
## Web3 Application
  ...
  - Интерфейс SpaceDex
    - Верстка страницы SpaceDex
    - Список доступных Space токенов для покупки с ценами
    - Кнопка для покупки Space токена за GALT
    - Список доступных Space токенов для продажи с ценами
      - Проверка Space токенов на возможность продажи(установлена цена и одобрен)
    - Кнопка для продажи Space токена за GALT
...
## Контракты
  - SpaceDex
    ...
    - Кешированние суммы всех цен Space токенов для вычитания их GaltDex
    - Заглушка GetSpacePrice с постоянной ценой
    - Заглушка AvailableForSell с постоянным true
  - GaltDex
    - SetSpaceDex
      - Установка адреса контракта SpaceDex для получение суммы всех цен
    - Вычитание суммы всех цен Space токенов при расчете курса GALT
    - Вычитание баланса SpaceDex при расчете курса GALT
