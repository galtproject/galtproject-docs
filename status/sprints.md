...
### Действия
 ...
 - Мои участки
   - Отображает список всех участков (геохешей и упаковок) с отображением на карте
...
### Методы
  ...
  - addTokenTo
    - Необходимо добавлять в массив маппинга по пользователю `to` передаваемый `geohash`
