...
- Добавить вариант отправки транзанкций с помощью персонального сгенерированного кошелька пользователя в браузере, на который пользователь может отправить ETH, чтобы кошелек в обход метамаск от имени пользователя подписал множество необходимых транзакций для регистрации участка
