...
## PlotClarificationManager - Никита
 ...
 - Передача токена обратно заявителю - 120 мин
 ...
 - Метод revertApplication, предпологаем изменение статуса на ```Возвращена``` с обнулением всех подтверждений валидаторами - 120 мин
   - Полного отказа в заявке не предусмотрено
 - Метод редактирования полей заявки заявителем (сразу всех) - 120 мин
 - Возврат токена участка и залога за газ и заявки заявителем - 150 мин
