...
### Действия
 ...
 - Заявки на рассмотрение
   ...
   - Отображать список всех заявок со всеми полями, со статусом Готов к рассмотрению, 45 мин
   - Для каждой заявки со статусом `Готово к рассмотрению` отображать кнопку `Проверить`. При нажатии кнопки `Проверить` отображаются поля, что пользователь указывал в заявке., 15 мин
