...
## Незапланированные задачи
  - Женя: Подготовить GaltProject UI для Демо показа
    - Автообновление информации(количество токенов, геохешей у пользователя или в упаковке/заявке, автообновление списков при изменении фильтрации), 120 минут.
    - Правка верстки и отображаемой информации для более представительного вида, 60 минут.
    - Показ дополнительной информации для облегчения понимания пользователем(демонстрация всех участков пользователя, числа геохешей в участках, упаковках, и прочее), 120 минут.
    - Дополнительная валидация и предупреждение пользователя о невозможности совершить действие, 120 минут.
  - Подготовка деплоя на продакшн:
    - Никита: Подготовка удаленной ноды для стабильной работы, тестирование работы, 240 минут
    - Женя: Подготовка конфигураций и деплоя контрактов и фронта для нескольких сетей(ganache, testnet56, local parity), тестирование работы связки контрактов и фронта, 240 минут
