...
## Backlog:
 ...
 - Конвертирование на клиенте все tokenId с маской геохеша, полученные из контрактов, в геохеши. Для этого добавить в galtproject-utils-js функции для определения типа tokenId: геохеш или упаковка и преобразование из tokenId в геохеш или упаковку.
- Доработать алгоритм аппроксимации так, чтобы наименьшие геохеши не выходили за границу контура
- **Сделано:** В интерфейсе добавить поле для определения точности аппроксимации
- **Сделано:** Выбор геохеша контура указанием на карте
- **Сделано:** Подсвесчивание геохеша контура при нажатии на инпут
...
- При проверке геохешей на вхождение в упаковку - если есть недостающие геохеши: показать их на карте в окне предупреждения выделив цветом среди других геохешей упаковки
