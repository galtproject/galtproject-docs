...
### Доработки (3.5 часа)
  ...
  - Разделение и обьединение геохешей в интерфейсе:
    - Кнопка, разделяющая геохеш
    - Кнопка вызывающая модальное окно с анализом того, какие геохеши могут быть обьеденены и выбором пользователем геохеша
  - Новый интерфейс создания упаковки
    - Отдельная страница для создания упаковки
    - Показ принадлежащих пользователю геохешей на карте
    - Выбор контуром новой упаковки на карте
    - Проверка на то, какие геохеши входя в паковку
    - Выделение другим цветом входящих в упаковку геохешей
    - Кнопка: добавить выбранные геохеши в паковку с отправкой транзанкции на инициализацию упаовку, добавлению в неё геохешей и установки контура
