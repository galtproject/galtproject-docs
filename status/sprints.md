...
## Explorer (9 часов 45 мин)
 - GaltMap
   - Описать конфигурацию запуска в Docker,
     - Dockerfile, 15 мин
   ...
   - Настроить транспорт (WSS)
     - Интегрировать Secure WebSocket (через socket.io), 240 мин
     - Интегрировать http server, 60 мин
     - Написать тест, 30 мин
   - CORS, кроссдоменные запросы, в том числе для wss
...
## TypeScript Telegram Bot (13 часов)
 - Bintan
   ...
   - Разбиение упаковок на геохеши [#445](https://github.com/galtspace/WIJG/issues/445), 180 мин
