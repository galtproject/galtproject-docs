...
![tutorial-pr-create-registry](https://raw.githubusercontent.com/galtproject-docs/master/examples/en/images/tutorial-pr-create-registry-3.png)
...
![tutorial-pr-create-registry](https://raw.githubusercontent.com/galtproject-docs/master/examples/en/images/tutorial-pr-create-registry-4.png)
...
![tutorial-pr-create-registry](https://raw.githubusercontent.com/galtproject-docs/master/examples/en/images/tutorial-pr-create-registry-5.png)
After clicking the Authorize in Geesome button, Metamask will start and ask you to sign the message.
![tutorial-pr-create-registry](https://raw.githubusercontent.com/galtproject-docs/master/examples/en/images/tutorial-pr-create-registry-6.png)
