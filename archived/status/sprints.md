...
| Евгений | Игорь | Иван | Никита |
| - | - | - | - |
| 91,80% | 85,62% | 28,37% | 100% |

# Sprint 1 - Задачи

## Web3 Application (21 час) (Сделано 100%) - Евгений
...
## SpaceToken (8 часов 20 минут) (Сделано 100%) - Никита

### Методы
  - Разработка метода [encode](../ru/contracts/SpaceToken.md#encode)
    - из 5-бит пакетов 
      - написать unit test, 15 минут
    - из 8-бит пакетов, 120 мин
  - Разработка метода [decode](../ru/contracts/SpaceToken.md#decode)
    - из 5-бит пакетов
      - написать unit test, 15 минут
    - из 8-бит пакетов, 120 мин
  - Разработка метода mint (выпуск токена)
...
## PlotManager (11 часов) (Сделано 100%) - Никита
...
### Методы
 ...
 - Метод claimApplication, 30 мин
   - ***Отказались*** Проверка что код страны и код города в заявке совпадает в данными валидатора
...
## SplitMerge (10 часов 45 минут) (Сделано 100%) - Евгений
...
## Explorer (9 часов 45 мин) (Сделано 100%) - Иван
 - GaltMap
...
## Solidity Telegram Bot (5 часов 15 мин) (Сделано 9,52%) - Иван
 - Web3 wrapper
...
## TypeScript Telegram Bot (7,5 часов) (Сделано 66,66%) - Иван
 - Bintan
...
## Технические задачи (5 часов 30 мин) (Сделано 100%) - Никита
...
### Доработки (16 часов 15 мин) (Сделано 100%) - Евгений
...
### Новый функционал (11 часов) (Сделано 100%) - Евгений
...
### GaltDEX (4 часа) (Сделано 100%) - Евгений
...
## Контракт GaltDEX (9 часов) (Сделано 100%) - Евгений
...
## Контракт PlotManager (31 час 45 мин) (Сделано 100%) - Никита
...
* Проверка, что заявки с ид не существует - 15 мин
...
* Передавать токен после завершения заявки бенефициару, а не подающему заявку - 60 мин
  
## TypeScript Telegram Bot (20 ч 30 мин) (Сделано 0%) - Иван
 - Bintan
...
## Solidity Telegram Bot Interface (10 ч 45 мин) (Сделано 0%) - Иван
...
## Solidity Bot (8 часов) (Сделано 50%) - Игорь
...
## Web3 Application (31 часов 45 минут) (73,22%) - Евгений
  ...
  - Раздел Администрирование
    - **Сделано** Добавление и удаление валидаторов с их ролями, 60 мин
    - **Сделано** Изменение минимальной комиссии и коэффициента в контракте PlotManager, 30 мин
    - Получение вознаграждения с комиссий для GaltSpace для каждого из участков, 30 мин
      - Список участков с кнопками: получить комиссию
  - **Сделано** Указание и отображение информации об отклонении и возвращении заявки валидатором: Валидатор должен написать текстом - что в заявке не правильно при REVERT и REJECT, 30 мин
...
## SplitMerge - Евгений 
 - **Не оценено** Добавить обработку/проверку addGeohashToPackage 
...
## Технические задачи (13 часов) (Сделано 100%) - Игорь
 - Обеспечить ревью кода (600 мин)
 - Необходимо 3 entry-point в 3-х разных провайдеров, на каждом по одной ноде Parity, 180 мин

## PlotClarificationManager (32 часов 30 мин) (Сделано 100%) - Никита
 ...
 - Создание заявки на рассчет геохешей - 120 мин
   ...
   - ***Отказались*** (Пункты 2 и 3 лучше объединить в одно действие)
 ...
 - Метод оценки валидатором стоимости работы над заявкой - 120 мин
   - Запись депозита заявки в ETH (ранее в GALT)
 ...
 - **(перенесено на следующий спринт)** Передача токена обратно заявителю - 120 мин
 ...
 - **(перенесено на следующий спринт)** Метод revertApplication, предпологаем изменение статуса на ```Возвращена``` с обнулением всех подтверждений валидаторами - 120 мин
   - Полного отказа в заявке не предусмотрено
 - **(перенесено на следующий спринт)** Метод редактирования полей заявки заявителем (сразу всех) - 120 мин
 - **(перенесено на следующий спринт)** Возврат токена участка и залога за газ и заявки заявителем - 150 мин
 - **(добавлено в середине спринта)** PlotManager. Починить поддержку бенефициара заявки по аналогии с ERC721 - 180 мин
...
## Backlog WebApplication
  ...
  - **На следующий спринт:** Добавить дополнительную информацию об RPC серверах с возможностью задания через ENV
  - **На следующий спринт:** Кран ETH: Пункт в меню со страничкой, где пользователь раз в 5 минут может получить 100 ETH
  ...
  - Вывод ошибок в логи в случае провала транзанкции
      - **На следующий спринт:** Анализ данных транзанкции, внутреннего кошелька и статуса сервера, 240 мин
  ...
  - **На следующий спринт:** Поиск по карте(по странам, городам и адресам)
  - **На следующий спринт:** Поиск по геохешам в Мои участки
  - **На следующий спринт:** При создании заявки - проверять что апроксимированные геохеши не принадлежат ни кому. Если принадлежат - подсвечивать и предупреждать пользователя с блокировкой кнопки создания заявки
  ...
  - **На следующий спринт:** Рядом с транзанкциями показывать сколько на них затрачено газа и эфиров
  - **На следующий спринт:** Оформить билд скрипты для продакшена
    - Минимизация
    - Обфускация
    - Динамическое имя сбилденного скрипта для избежания проблемы кеширования у пользователя
  ...
  - **На следующий спринт:** Убрать слово "Упаковка" из интерфейса и заменить на "Земельный участок"
  - **На следующий спринт:** Выводить токены SPACE в hex в интерфейсе
  - **На следующий спринт:** Перезагружать интерфейс при измененении кошелька в MetaMask
  ...
  - **На следующий спринт:** Поставить ограничение на максимальный размер геохеша для регистрирования территории чтобы избежать злоупотребления, 30 мин
  - **На следующий спринт:** В интерфейсе проверять площадь указанного пользователем контура и предупреждать в соответствии с площадью - какую точность он может указать, а какая приведет к долгим расчетам., 90 мин
  - **На следующий спринт:** Возможность сбросить валидатора владельцем контракта
