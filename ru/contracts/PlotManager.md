...
2. При нажатии на кнопку отображается в всплывающем окне Адрес(ссылка на Etherscan), список транзакций со статусом и ссылки на них на Etherscan и кнопка `Скопировать приватный ключ`. При нажатии ключ копируется в буфер.
