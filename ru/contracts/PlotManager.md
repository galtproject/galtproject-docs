...
- DISASSEMBLED_BY_APPLICANT - заявка отклонена (разобрана зявителем) (сейчас не используется)
- DISASSEMBLED_BY_VALIDATOR - заявка отклонена (разобрана валидатором) (сейчас не используется)
- CLOSED - заявка закрыта заявителем
