...
|Параметр|Значение|
|--------|--------|
|3-N точек границ Земельного участка в формате Геохеш - координат|[w24qgy48e](http://explorer.galtproject.io/map/#w24qgy48e), [w24qgsqw3](http://explorer.galtproject.io/map/#w24qgsqw3), [w24qgumbk](http://explorer.galtproject.io/map/#w24qgumbk) или GPS координат|
...
Вызывается метод. Создается новый SPACE - токен`Упаковки`. 
...
Заявка записывается в Контракт. Пользователь оплачивает невозвратную комиссию за рассмотрение заявки.
...
7. Токен 743883bs7GEOw24qgy48hgdhhqgddqw663w24qgumbk передается пользователю.

|Токен SPACE|Владелец|
|-----|--------|
|743883bs7GEOw24qgy48hgdhhqgddqw663w24qgumbk|Заявитель 0xFB7442a......69e3 |

8. `Нотариус заявки` получает 1 ETH.
