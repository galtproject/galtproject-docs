...
## Описание проблемы
Необходимо дать возможность любому Человеку, который владеет Землей - добавить свой `Земельный участок` в проект. При этом форма участка может быть произвольной. Обеспечит возможность связи с текущей правовой системой путем создания института Гарантов прав.
...
- Разделить владение токеном участка и владение землей в общепринятой правовой системе. Обеспечить гарантию прав и надежность.
- Создать экономическую выгоду для того, кто является Кастодианом на землю в государственном реестре.
...
- Регистрацция участка.
- Уточнение границ по участку.
...
## Сценарий UI 16: Регистрация владельца токена участка, как `Гаранта прав`(Кастодиана) по участку.
...
|Заявитель|Адрес|Владелец выбранного токена|Заполняется автомаьтически|
...
## Сценарий UI 17: Утверждение Гаранта Прав
...
## Сценарий UI 21: Отмена заявки на регистрацию Кастодиана 
...
2. Если начисленное вознаграждение не выплачено вовремя, то на него начисляются штрафные санкции.
3. Если вознаграждение не выплачено, то изменение Кастодиана невозможно.
