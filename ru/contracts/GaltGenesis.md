...
6. Если Генезис закончен и цель с учетом погрешности достигнута, то контракт Генезиса GALT Территории создает токены GALT, вызывет метод mint() контракта GaltToken и становится их владельцем.
