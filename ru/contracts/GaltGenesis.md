...
7. Каждый адрес, который перечислял Эфиры на контракт может затребовать GALT пропорционально перечисленным Эфирам.
...
### Сценарий 1: GALTGenesis общий случай Тип 1.
1. Успешно принятая заявка в CreateTerritory добавила в контракт GaltGenesisRegistry следующую  информацию:
