...
### Сценарий 16: Разбиение существующего участка на части с одновременным созданием новых участков
0. Для определения пересечений участка и произвольного контура используется алгоритм Уайлера — Атертона.
1. Пользователь для Участка может в меню нажать кнопку "Межевать".
2. Появится всплывающее окно. В нем отображается существующий участок с геохешами и надпись "Укажите замкнутый контур для разбиения участка на части.
3. Пользователь указывает контур в виде многоугольника, который пересекает текущий участок (аналогично созданию нового участка). Происходит расчет пересечения по алгоритму Уайлера — Атертона. В отдельном блоке под картой, где задавался контур. отображаются два новых участка, полученных при помощи алгоритма.
4. Здесь же отображаются геохеши, которые войдут в новые участки.
5. Пользователь нажимает кнопку Подтвердить.
6. Создается 1 новый участок. Геохеши из старого участка передаются в новый. У старого участка меняется граница!
7. Пользователь нажимает "Разобрать и перенести геохеши". Создается серия транзакций.
8. Эту кнопку можно нажать так же в меню Участка с указанием участков, которые должны получить геохеши.

### Сценарий 17: Обьединение двух участков

1. Пользователь может нажать кнопку "Обьединить участки". Появится окно с предложением указать 2 участка.
2. Участки могут быть обьединены, Если они имеют 2 общие вершины.
3. Если проверка пройдена, то пользователь может нажать "Подтвердить" и будет создан новых участок, полученный обьединением двух начальных.
4. Пользователь нажимает кнопку "Разобрать и перенести геохеши". Создается серия транзакций.
5. Эту кнопку можно нажать так же в меню Участка с указанием участков, которые должны получить геохеши.

### Методология учета граница Земельного участка

Любой земельный участок произвольной формы на карте является выпуклым многоугольником, который имеет следующие геометрически параметры: вершины многоугольника, грани многоугольника.

В общем случае грань многоугольгика может быть прямой линией или кривой. Если с прямой линией все понятно, то тип кривой для построения математической модели участка необходимо выбрать. В основном для математической апроксимации кривой, построенной по набору точек используются Сплайны различных видов. Данный вид кривых широко испльзуется в инженерной и компьютерной графике.

Формалная постановка задачи: необходимо определить математическую модель кривой, которая будет определять границу Земельного Участка и проходить через заданные точки.

#### Выбор Сплайна для математического описания криволинейной границы Земельного участка
Скорее всего наболее подходят кривые Безье Второго Порядка. Необходимо проработать обоснование.

#### Структура данных
Для описания математической модели Земельного участка необходимо в первую очередь определить требования к этой модели. 
Определим эти требования:
- модель должна давать возможность отобразить многоугольник Земельного участка в приложении;
- модель должна давать возможность выполнять стандартные математически операции, такие как: определение точки пересечения прямых, определение точки пересечения прямой и сплайна, расстояние от точки до прямой, рсстояние от точки до сплайна.
