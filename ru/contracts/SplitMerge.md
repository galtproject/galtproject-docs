...
### Сценарий 15: Разбиение существующего участка на части с одновременным созданием новых участков
...
3. Пользователь указывает контур в виде многоугольника, который пересекает текущий участок (аналогично созданию нового участка). Происходит расчет пересечения по алгоритму Уайлера — Атертона. Отображаются старый участок одним цветом и два новых участка, полученных при помощи алгоритма.
