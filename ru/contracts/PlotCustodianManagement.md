...
* `CLOSED` - закрыта (токен переведен обратно заявителю)
...
* Флаг TOKEN_ATTACHED становится равен true
...
* Флаг TOKEN_ATTACHED должен быть равен true
* Проставляется флаг TOKEN_ATTACHED = false
...
* Не понятна мотивация заявителя делать #closeApplication()
