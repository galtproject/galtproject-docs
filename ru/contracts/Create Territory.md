...
| Минимальный размер участка на аукционе| 7  |	Примерныый размер ≤ 153m	×	153m |
...
|---------|-----------| ----------- |
|TerritoryPropVote |10 000| 10 1340 |

Если получено 66% от общей репутации всех участников, то заявка принимается.
