...
Любой может увеличить Залог и соответствующую `Репутацию` токены SPACE, пополнив Залог на любую сумму от 1 GALT и указав `Фонд` и адрес Пользователя, на которые она будет распределена.

#### Fine - Списание репутации SPACE токена.
Право на списание `Залога` SPACE токена и соответствующей `Репутации` принадлежит только контракту [ReputationFine](https://github.com/andromedaspace/galtproject-docs/blob/master/ru/contracts/ReputationFine.md). 
