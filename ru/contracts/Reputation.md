...
### Пример 1В. Частичное переназначение репутации с помощью прямого переноса репутации между фондами (Владельцем токена является централизованный офф-чейн скрипт с приватным ключем):
