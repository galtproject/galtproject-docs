...
|———|———|——————|—————|
|Участок|ID|Значение по умолчанию||
...
3. Создается транзакция с методом контракта PlotEscrow, которая меняет статус заявки на `Выполнена` и записывает в маппинг Гаранта участка со всеми данными, включая название. Фиксируется размер комиссии Кастодиана.
...
## Сценарий UI 6: Выставление участка на продажу
