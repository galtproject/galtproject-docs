...
Владелец при утверждении Заявки платит ГАЗ и 

Контракт CreateTerritory создает токен или токены GALT Территории, вызывая метод mint() контракта GaltToken и назначает их Владельцем SPACEAuctionRegistry. 
