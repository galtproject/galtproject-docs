...
|---------|-----------| ----------- |
| Токен Территории| Например, 743883bs7GEOw24qgy48hgdhhqgddqw663w24qgumbk. Токен SPACE `Упаковки`, которая соответствует новому большому участку. Должен быть создан заранее при помощи контракта AddNewPlot и упакован через SplitMerge.|
