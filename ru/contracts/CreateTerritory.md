...
Владелец при утверждении Заявки платит ГАЗ и Контракт CreateTerritory создает токен или токены GALT Территории, вызывая метод mint() контракта SpaceToken и назначает их Владельцем SPACEAuctionRegistry. 
