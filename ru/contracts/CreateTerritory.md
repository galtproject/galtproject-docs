...
- Владелец Территории - физическое лицо, юридическое лицо, экономический агент, который владеет участком земли в той или иной юрисдикции. Может при помощи тех или иных юридических механизмов продать землю участникам Galt Project. Имеет свой адрес в сети Ethereum;
- Оператор ввода Территории в проект - физическое лицо, юридическое лицо, экономический агент, который предлагает включить Территорию в Galt Project;
...
- размер комиссии от Эфиров для Оператора ввода Территории;
...
| Стоимость Территории в Эфирах| 15 000 | Эта сумма, которую хочет получить владелец за передачу прав на всю землю [w24qg]( http://explorer.galtproject.io/map/#w24qg ) |
| Количество выпускаемых под Территорию GALT| 15 000 000 | Эта сумма GALT, которая будет выпущена для привлечения средств инвесторов для выкупа Территории [w24qg]( http://explorer.galtproject.io/map/#w24qg ) |
...
| Процент получаемого вознаграждения за землю Оператором ввода Территории | 10 |Это означает, что из 13 500 Эфиров, которые идут на выкуп Территории,  Оператор ввода Территории получит 10% или 1 350 Эфиров.|
