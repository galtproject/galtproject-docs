...
| Стоимость Территории в Эфирах| 15 000 | Эта сумма, которую хочет получить владелец за передачу прав на всю землю [w24qg]( http://explorer.galtproject.io/map/#w24qg ) и и [w24qex](http://explorer.galtproject.io/map/#w24qex)|
| Количество выпускаемых под Территорию GALT| 15 000 000 | Эта сумма GALT, которая будет выпущена для привлечения средств инвесторов для выкупа Территории [w24qg]( http://explorer.galtproject.io/map/#w24qg ) и и [w24qex](http://explorer.galtproject.io/map/#w24qex)|
