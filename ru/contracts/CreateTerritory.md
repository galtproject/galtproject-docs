...
4. Если заявка была принята так же контракт CreateTerritory добавляет адрес контракта Аукциона земли из заявки в контракт SPACEAuctionRegistry. То есть каждый раз заранее задеплоенный контракт добьавляется в SPACEAuctionRegistry на конкретную территорию.

4. Далее - Контракт GaltGenesis.
