...
4. GALT Project CORE Team запускает контракт SPACEAuctionRegistry. При помощи него Владелец Территории, которая первой будет продана Проекту, сможет размежевать эту Территорию на отдельные Земельные участки для `Аукциона земли`.
