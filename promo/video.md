...
|2|In Galt Project you can trade your land or real estate ERC721 tokens for Ether, Stable Coins or any ERC20 tokens using smart contracts.|В Galt Project вы можете продать свои токены ERC721 земельных участков или недвижимости за Эфиры, Стейблкойны или любые токены ERC20, используя умные контракты.|Показываем окно с токенами|
