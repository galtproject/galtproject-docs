...
|4|Building areas tokens are same as Land plot tokens, except that they each of them do not represent a land plot, but a specific area of a building. And also they store geographical coordinates|Токены площадей зданий такие же как токены земельных участков, кроме того что каждый из них представляют не земельный участок, а конкретную площадь здания. Они так же хранят географические координаты.|Те, же самые действия, что и выше, нужно добавить переход на вид со зданием в 3D и обратно.|
