...
Galt Protocol is a consistent geospatial registry of land and real estate (which can be used for trading, rental, creating CDP's or taking loans ), system of multisigs for storing and managing public budgets and self-governance and simple and  voting system to define society rules by direct or delegative voting. 
