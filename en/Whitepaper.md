...
### Token rental
We define a land or real-estate token rental as the ability to perform various operations with a token according to Smart contract between Token Owner and Token Tenant using a private key.
