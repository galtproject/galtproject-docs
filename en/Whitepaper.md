...
and the token Owner didn't cancel the destruction), the token is destroyed and the registry owner can issue a new token with same geographically coordinates and data.
